...
public : 
  ...
  skimSamples(region r=kPhoton){
    ...
    if( r == kDYmLDP )
      skimType="root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_DYmLDP_CleanVars";
    if( r == kDYe )
      skimType="root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_DYe_CleanVars";
    if( r == kDYeLDP )
      skimType="root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV10/tree_DYeLDP_CleanVars";
